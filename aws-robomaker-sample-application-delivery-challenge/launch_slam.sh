...
S3_BUCKET="deliverychallengevocstar-robomakerdeliverychallen-bi8ad6wvktc4"
ROLE_ARN="arn:aws:iam::885489761587:role/delivery-challenge-simulation-role-us-east-1"
SUBNET='["subnet-d4f0b4b2", "subnet-e97265a4", "subnet-ad9f149c", "subnet-b80c4ce7", "subnet-12793b33", "subnet-eb7940e5"]' # example  '["subnet-1303f974", "subnet-939d74da", "subnet-d7063791"]'
SECURITY_GROUP='["sg-74b8f372"]' # example '["sg-012ffd67"]'
...
SIMULATION_APPNAME="deliverychallenge_sumulation_user1486240-cxu38-myseneca-ca"
SIM_APP_PACKAGE="delivery_challenge_simulation"
SIM_APP_LAUNCH_FILE="create_stage0.launch"
SIM_APP_ENV="{\"TURTLEBOT3_MODEL\": \"burger\"}"

ROBOT_APPNAME="deliverychallenge_robot_user1486240-cxu38-myseneca-ca"
